...
export default function Text({
  ...
  const onSubmit = handleSubmit((values) => {
    ...
    if (
      ...
      router.push(
        `${leaveReferenceBaseRoute}/${referenceType}/${user.userId}/${referenceStepStrings[4]}`,
      );
    } else {
      router.push(
        `${leaveReferenceBaseRoute}/${referenceType}/${user.userId}/${hostRequestId}/${referenceStepStrings[4]}`,
      );
    }
  });
